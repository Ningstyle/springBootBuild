...
import com.small.business.service.VFemsCsrTypeService;
...
@Service
@Transactional
public class VFemsCsrTypeImpl extends ServiceImpl<VFemsCsrTypeMapper, VFemsCsrType> implements VFemsCsrTypeService {

    private static Logger logger = LogManager.getLogger(VFemsCsrTypeImpl.class);
