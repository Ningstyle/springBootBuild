...
import com.small.business.service.VFemsCsrDetailListService;
...
@Service
@Transactional
public class VFemsCsrDetailListImpl extends ServiceImpl<VFemsCsrDetailListMapper, VFemsCsrDetailList> implements VFemsCsrDetailListService {

    private static Logger logger = LogManager.getLogger(VFemsCsrDetailListImpl.class);
