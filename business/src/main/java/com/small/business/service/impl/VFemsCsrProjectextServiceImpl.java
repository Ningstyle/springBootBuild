...
@Service
@Transactional
public class VFemsCsrProjectextServiceImpl extends ServiceImpl<VFemsCsrProjectextMapper,VFemsCsrProjectext> implements VFemsCsrProjectextService {

    private static Logger logger = LogManager.getLogger(VFemsCsrProjectextServiceImpl.class);
