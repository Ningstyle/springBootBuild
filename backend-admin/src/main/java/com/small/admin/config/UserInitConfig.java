...
import com.small.admin.common.enums.DataCenterEnum;
import com.small.admin.common.utils.SnowflakeIdWorker;
...
public class UserInitConfig {
    ...
    public Object initWorkerId(@Value("${system.type}") String sysType) throws Exception {
        ...
        log.info("雪花算法初始化完毕，next_id = " + SnowflakeIdWorker.nextId());
